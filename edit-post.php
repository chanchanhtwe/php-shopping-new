...
//print_r($post); //to know database data is arrived
?>
...
<head>
    ...
    <title>Thaton Shopping >> Edit Posts</title>
...
<div class="container">
    <div class="page-header">
        <h5>
            <i class="glyphicon glyphicon-edit"></i> Edit Posts
    ...
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <form enctype="multipart/form-data" method="post" action="update-post.php">
                ...
                <div class="form-group">
                    ...
                    <select name="category_id" id="category_id" class="form-control" required>
                        ...
                        foreach ($cats as $c) {
                            ?>
                            <option
                                <?php if($post['category_id']==$c['id']){ echo "selected"; } ?>
                                value="<?php echo $c['id'] ?>"><?php echo $c['category_name'] ?></option>
                            <?php
                        }
                        ?>
                    </select>
